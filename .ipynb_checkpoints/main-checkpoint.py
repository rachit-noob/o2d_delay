...
class o2d_predictor:
    ...
    def o2d_calculator(self):
        ...
        return ((self.value_dict[self.category][0] + self.value_dict[self.buyer][0] + self.value_dict[self.seller][0] + self.value_dict[self.lane][0] )/4).round(2)
...
if __name__ == "__main__":
    ...
    o2d_prediction = o2d_predictor(df)
